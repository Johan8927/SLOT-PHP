...
if (filter_has_var(INPUT_POST, 'nom') && (filter_has_var(INPUT_POST, 'prénom') && (filter_has_var (INPUT_POST, 'email') &&(filter_has_var (INPUT_POST, 'raison') && (filter_has_var, 'message'))){
}
...
$raison = filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL);
...
echo "message :" . htmlspecialchars($email) . <br>;
}
else {
